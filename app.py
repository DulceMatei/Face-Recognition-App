...
class MainApp(QMainWindow):
    def __init__(self):
        ...
        # parameters
        self.caleDS = "C:\\users\\matei\\Desktop\\Poze"
        self.training = 8
...
# button connect
    ...
    def nn(self, A, poza_selectata, norma):
        ...
        cale_imagine = f"C:\\users\\matei\\Desktop\\Poze\s{index_gasit // 8 + 1}\\1.pgm"
    ...
    def knn(self, A, poza_selectata, norma, k):
        ...
        cale_imagine = f"C:\\users\\matei\\Desktop\\Poze\\s{index_gasit}\\1.pgm"
        self.afisare_imagine_calculata(cale_imagine)
